    ...
    return (
        ...
        <h3>Compartilhe</h3>
            <div className="justify-between flex flex-row">
                ...
                <Link target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.simmp.com.br%2F&amp;src=sdkpreparse" className="fb-xfbml-parse-ignore" title="Share on Facebook">
